...
import { CountDown, CountDownHandle } from '../timer/timer';
...
interface PlayerProps {
    ...
    onTimeOver?: () => void;
    gameEnded?: boolean;
    timerRef?: RefObject<CountDownHandle>;
...
export const Player = (props: PlayerProps) => {
    ...
    const [selectedKey, setSelectedKey] = useLocalStorage<string | undefined>(key, initialSelected);
